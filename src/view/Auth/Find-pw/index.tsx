            ...
            <div id="findPW">
                ...
                <div className="box">
                    ...
                    <div className="tel-box">
                        ...
                        <div className={(telNumber.length === 11 && userId) ? "send-btn" : "send-btn-false"}
                ...
                onClick={error && isMatched ? findIDResult : undefined}>비밀번호 재설정</div>
